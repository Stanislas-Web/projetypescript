import { dbconnection, Insert, DeleteAnd, DeleteOr, SelectWhereAnd, SelectWhereOr, Limit, Update, Select } from "./connection";
import { queryCallback } from "mysql";

export class ProduitDAO {
    private tableName = "produit";
    private idColumn="Id";
    private static _instance: ProduitDAO;
    public static get instance() {
        if (!this._instance) {
            this._instance = new ProduitDAO();
        }
